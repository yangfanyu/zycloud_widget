...
class DartuiLibrary {
  ...
  static final classChannelBuffers = VmClass<ChannelBuffers>(
    ...
    externalProxyMap: {
      ...
      'sendChannelUpdate': VmProxy(identifier: 'sendChannelUpdate', externalInstancePropertyReader: (ChannelBuffers instance) => instance.sendChannelUpdate),
  ...
  static final classFontVariation = VmClass<FontVariation>(
    ...
    externalProxyMap: {
      ...
      'italic': VmProxy(identifier: 'italic', externalStaticPropertyReader: () => FontVariation.italic),
      'opticalSize': VmProxy(identifier: 'opticalSize', externalStaticPropertyReader: () => FontVariation.opticalSize),
      'slant': VmProxy(identifier: 'slant', externalStaticPropertyReader: () => FontVariation.slant),
      'weight': VmProxy(identifier: 'weight', externalStaticPropertyReader: () => FontVariation.weight),
      'width': VmProxy(identifier: 'width', externalStaticPropertyReader: () => FontVariation.width),
      'lerp': VmProxy(identifier: 'lerp', externalStaticPropertyReader: () => FontVariation.lerp),
  ...
  static final classParagraphBuilder = VmClass<ParagraphBuilder>(
    ...
    externalProxyMap: {
      ...
      'setDisableRoundingHack': VmProxy(identifier: 'setDisableRoundingHack', externalStaticPropertyReader: () => ParagraphBuilder.setDisableRoundingHack),
      'shouldDisableRoundingHack': VmProxy(identifier: 'shouldDisableRoundingHack', externalStaticPropertyReader: () => ParagraphBuilder.shouldDisableRoundingHack),
  ...
  static final classPlatformDispatcher = VmClass<PlatformDispatcher>(
    ...
    externalProxyMap: {
      ...
      'onBeginFrame': VmProxy(identifier: 'onBeginFrame', externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onBeginFrame, externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onBeginFrame = value),
      'onDrawFrame': VmProxy(identifier: 'onDrawFrame', externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onDrawFrame, externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onDrawFrame = value),
      'onError': VmProxy(identifier: 'onError', externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onError = value, externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onError),
      'onFrameDataChanged': VmProxy(identifier: 'onFrameDataChanged', externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onFrameDataChanged = value, externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onFrameDataChanged),
      ...
      'onLocaleChanged': VmProxy(identifier: 'onLocaleChanged', externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onLocaleChanged = value, externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onLocaleChanged),
      ...
      'onPlatformBrightnessChanged': VmProxy(identifier: 'onPlatformBrightnessChanged', externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onPlatformBrightnessChanged = value, externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onPlatformBrightnessChanged),
      ...
      'onPlatformMessage': VmProxy(identifier: 'onPlatformMessage', externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onPlatformMessage, externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onPlatformMessage = value),
      ...
      'onReportTimings': VmProxy(identifier: 'onReportTimings', externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onReportTimings, externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onReportTimings = value),
      ...
      'onSystemFontFamilyChanged': VmProxy(identifier: 'onSystemFontFamilyChanged', externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onSystemFontFamilyChanged = value, externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onSystemFontFamilyChanged),
      'onTextScaleFactorChanged': VmProxy(identifier: 'onTextScaleFactorChanged', externalInstancePropertyWriter: (PlatformDispatcher instance, value) => instance.onTextScaleFactorChanged = value, externalInstancePropertyReader: (PlatformDispatcher instance) => instance.onTextScaleFactorChanged),
      ...
      'scaleFontSize': VmProxy(identifier: 'scaleFontSize', externalInstancePropertyReader: (PlatformDispatcher instance) => instance.scaleFontSize),
  ...
  static final classSemanticsFlag = VmClass<SemanticsFlag>(
    ...
    externalProxyMap: {
      ...
      'hasExpandedState': VmProxy(identifier: 'hasExpandedState', externalStaticPropertyReader: () => SemanticsFlag.hasExpandedState),
      ...
      'isExpanded': VmProxy(identifier: 'isExpanded', externalStaticPropertyReader: () => SemanticsFlag.isExpanded),
  ...
  static final classSingletonFlutterWindow = VmClass<SingletonFlutterWindow>(
    ...
    externalProxyMap: {
      ...
      'onPointerDataPacket': VmProxy(identifier: 'onPointerDataPacket', externalInstancePropertyWriter: (SingletonFlutterWindow instance, value) => instance.onPointerDataPacket = value, externalInstancePropertyReader: (SingletonFlutterWindow instance) => instance.onPointerDataPacket),
      ...
      'onTextScaleFactorChanged': VmProxy(identifier: 'onTextScaleFactorChanged', externalInstancePropertyReader: (SingletonFlutterWindow instance) => instance.onTextScaleFactorChanged, externalInstancePropertyWriter: (SingletonFlutterWindow instance, value) => instance.onTextScaleFactorChanged = value),
