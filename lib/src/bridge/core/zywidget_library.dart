...
class ZywidgetLibrary {
  ...
  static final classZySpriteQueue = VmClass<ZySpriteQueue>(
    ...
    externalProxyMap: {
      ...
      'isEmpty': VmProxy(identifier: 'isEmpty', externalInstancePropertyReader: (ZySpriteQueue instance) => instance.isEmpty),
      'isNotEmpty': VmProxy(identifier: 'isNotEmpty', externalInstancePropertyReader: (ZySpriteQueue instance) => instance.isNotEmpty),
  ...
  static final classZySpriteState = VmClass<ZySpriteState>(
    ...
    externalProxyMap: {
      ...
      'isEmpty': VmProxy(identifier: 'isEmpty', externalInstancePropertyReader: (ZySpriteState instance) => instance.isEmpty),
      'isNotEmpty': VmProxy(identifier: 'isNotEmpty', externalInstancePropertyReader: (ZySpriteState instance) => instance.isNotEmpty),
