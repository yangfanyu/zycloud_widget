...
class WebviewFlutterLibrary {
  ...
  static final classNavigationDelegate = VmClass<NavigationDelegate>(
    ...
    superclassNames: ['Object'],
    externalProxyMap: {
      'new': VmProxy(identifier: 'new', externalStaticPropertyReader: () => NavigationDelegate.new, externalStaticFunctionCaller: ({onNavigationRequest, onPageStarted, onPageFinished, onProgress, onWebResourceError, onUrlChange, onHttpAuthRequest}) => NavigationDelegate.new(onNavigationRequest: onNavigationRequest == null ? null : (b0) => onNavigationRequest(b0), onPageStarted: onPageStarted == null ? null : (b0) => onPageStarted(b0), onPageFinished: onPageFinished == null ? null : (b0) => onPageFinished(b0), onProgress: onProgress == null ? null : (b0) => onProgress(b0), onWebResourceError: onWebResourceError == null ? null : (b0) => onWebResourceError(b0), onUrlChange: onUrlChange == null ? null : (b0) => onUrlChange(b0), onHttpAuthRequest: onHttpAuthRequest == null ? null : (b0) => onHttpAuthRequest(b0))),
      'fromPlatform': VmProxy(identifier: 'fromPlatform', externalStaticPropertyReader: () => NavigationDelegate.fromPlatform, externalStaticFunctionCaller: (a0, {onNavigationRequest, onPageStarted, onPageFinished, onProgress, onWebResourceError, onUrlChange, onHttpAuthRequest}) => NavigationDelegate.fromPlatform(a0, onNavigationRequest: onNavigationRequest == null ? null : (b0) => onNavigationRequest(b0), onPageStarted: onPageStarted == null ? null : (b0) => onPageStarted(b0), onPageFinished: onPageFinished == null ? null : (b0) => onPageFinished(b0), onProgress: onProgress == null ? null : (b0) => onProgress(b0), onWebResourceError: onWebResourceError == null ? null : (b0) => onWebResourceError(b0), onUrlChange: onUrlChange == null ? null : (b0) => onUrlChange(b0), onHttpAuthRequest: onHttpAuthRequest == null ? null : (b0) => onHttpAuthRequest(b0))),
      'fromPlatformCreationParams': VmProxy(identifier: 'fromPlatformCreationParams', externalStaticPropertyReader: () => NavigationDelegate.fromPlatformCreationParams, externalStaticFunctionCaller: (a0, {onNavigationRequest, onPageStarted, onPageFinished, onProgress, onWebResourceError, onUrlChange, onHttpAuthRequest}) => NavigationDelegate.fromPlatformCreationParams(a0, onNavigationRequest: onNavigationRequest == null ? null : (b0) => onNavigationRequest(b0), onPageStarted: onPageStarted == null ? null : (b0) => onPageStarted(b0), onPageFinished: onPageFinished == null ? null : (b0) => onPageFinished(b0), onProgress: onProgress == null ? null : (b0) => onProgress(b0), onWebResourceError: onWebResourceError == null ? null : (b0) => onWebResourceError(b0), onUrlChange: onUrlChange == null ? null : (b0) => onUrlChange(b0), onHttpAuthRequest: onHttpAuthRequest == null ? null : (b0) => onHttpAuthRequest(b0))),
  ...
  static final classWebViewController = VmClass<WebViewController>(
    ...
    externalProxyMap: {
      ...
      'setOnJavaScriptAlertDialog': VmProxy(identifier: 'setOnJavaScriptAlertDialog', externalInstancePropertyReader: (WebViewController instance) => instance.setOnJavaScriptAlertDialog, externalInstanceFunctionCaller: (WebViewController instance, a0) => instance.setOnJavaScriptAlertDialog((b0) => a0(b0))),
      'setOnJavaScriptConfirmDialog': VmProxy(identifier: 'setOnJavaScriptConfirmDialog', externalInstancePropertyReader: (WebViewController instance) => instance.setOnJavaScriptConfirmDialog, externalInstanceFunctionCaller: (WebViewController instance, a0) => instance.setOnJavaScriptConfirmDialog((b0) => a0(b0))),
      'setOnJavaScriptTextInputDialog': VmProxy(identifier: 'setOnJavaScriptTextInputDialog', externalInstancePropertyReader: (WebViewController instance) => instance.setOnJavaScriptTextInputDialog, externalInstanceFunctionCaller: (WebViewController instance, a0) => instance.setOnJavaScriptTextInputDialog((b0) => a0(b0))),
      'setOnScrollPositionChange': VmProxy(identifier: 'setOnScrollPositionChange', externalInstancePropertyReader: (WebViewController instance) => instance.setOnScrollPositionChange, externalInstanceFunctionCaller: (WebViewController instance, a0) => instance.setOnScrollPositionChange(a0 == null ? null : (b0) => a0(b0))),
