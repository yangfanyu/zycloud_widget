...
class ZyClientLibrary {
  ...
  static final classNetClient = VmClass<NetClient>(
    ...
    superclassNames: ['Object'],
    externalProxyMap: {
      'new': VmProxy(identifier: 'new', externalStaticPropertyReader: () => NetClient.new, externalStaticFunctionCaller: ({logger = EasyLogger.printLogger, logLevel = EasyLogLevel.debug, logTag, host = '', port = 0, bsid = '', secret = '', binary = true, isolate = true, sslEnable = false, onCredentials}) => NetClient.new(logger: (b0, b1, b2) => logger(b0, b1, b2), logLevel: logLevel, logTag: logTag, host: host, port: port, bsid: bsid, secret: secret, binary: binary, isolate: isolate, sslEnable: sslEnable, onCredentials: (b0, b1) => onCredentials(b0, b1))),
      ...
      'binary': VmProxy(identifier: 'binary', externalInstancePropertyReader: (NetClient instance) => instance.binary),
      ...
      'host': VmProxy(identifier: 'host', externalInstancePropertyReader: (NetClient instance) => instance.host),
      ...
      'logger': VmProxy(identifier: 'logger', externalInstancePropertyReader: (NetClient instance) => instance.logger),
      ...
      'logLevel': VmProxy(identifier: 'logLevel', externalInstancePropertyReader: (NetClient instance) => instance.logLevel),
      'logTag': VmProxy(identifier: 'logTag', externalInstancePropertyReader: (NetClient instance) => instance.logTag),
      ...
      'paymentExists': VmProxy(identifier: 'paymentExists', externalInstancePropertyReader: (NetClient instance) => instance.paymentExists),
      ...
      'port': VmProxy(identifier: 'port', externalInstancePropertyReader: (NetClient instance) => instance.port),
      ...
      'sslEnable': VmProxy(identifier: 'sslEnable', externalInstancePropertyReader: (NetClient instance) => instance.sslEnable),
